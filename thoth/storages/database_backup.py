...
"""Adapter for storing database backups."""
...
class DatabaseBackup(StorageBase):
    """Adapter for storing database backups."""

    RESULT_TYPE = "database-backup"
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize adapter for storing database backups.
    ...
    def store_backup(self, backup_file: str) -> str:
